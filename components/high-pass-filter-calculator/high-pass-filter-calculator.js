import {
  CAPACITANCE_UNITS,
  RESISTANCE_UNITS,
  calculateHighPassResistance,
  calculateHighPassRc,
  capacitanceToFarads,
  formatScaledUnit,
  frequencyToHz,
  resistanceToOhms,
} from "./high-pass-filter-logic.js";

const template = document.createElement("template");
template.innerHTML = `
  <link rel="stylesheet" href="./components/high-pass-filter-calculator/high-pass-filter-calculator.css">
    ...
    <form>
      ...
      <label>
        ...
        <span class="input-row">
          <input name="cutoff" type="number" min="0" step="1" value="300">
...
class HighPassFilterCalculator extends HTMLElement {
  connectedCallback() {
  ...
  renderResults() {
    ...
    try {
      ...
      this.results.innerHTML = `
        ${mainResult}
        ${resultRow("Topologia", "C em serie, R em paralelo")}
...
customElements.define("high-pass-filter-calculator", HighPassFilterCalculator);
